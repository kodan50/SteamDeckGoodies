...
# This only cleans up local files stored on the Steam Deck's internal hard drive, not the memory card. Perhaps I will address this in the future.
# This also requires the onboard keyboard to press the buttons. Or run it through SSH. Perhaps I will address this in the future.
import os
import shutil
